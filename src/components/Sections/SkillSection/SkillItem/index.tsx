...
function SkillItem({
    ...
    inView,
    clicked,
}: Pick<SkillType, 'icon' | 'title'> & { animation: string; inView: boolean; clicked: boolean }) {
    ...
    return (
        <li className=" w-[10em] h-full  flex items-center justify-center">
            <div
                className={` relative flex w-[60%] text-neutral-50 ${
