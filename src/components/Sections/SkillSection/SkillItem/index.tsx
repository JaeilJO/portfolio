...
function SkillItem({ icon, title }: Pick<SkillType, "icon" | "title">) {
  ...
  return (
    <li className=" w-[10em] h-[10em] flex items-center justify-center ">
      <div
        className={`relative flex w-[60%] text-neutral-50 ${dark_light.current}  ${main_color.current} justify-center items-center gap-2 h-[3.5em] text-left skew-x-[25deg] rotate-[-30deg] duration-200 shadow-[-40px_40px_10px_rgba(0,0,0,0.5)] animate-section_skill_animation`}
      >
        <div
