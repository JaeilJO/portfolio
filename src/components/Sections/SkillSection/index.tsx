        ...
        <div className="flex w-screen h-screen max-sm:flex-col">
            ...
            <div className="relative flex items-center justify-center w-full h-full max-sm:items-start">
                <div className="absolute z-30 flex w-full h-full">
                    <button className="relative flex items-center justify-center w-full h-full" onClick={leftClick}>
                        <div
                            className={`w-full text-5xl flex justify-center items-center  animate-bounce duration-200 ${
