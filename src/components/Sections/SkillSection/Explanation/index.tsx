...
function Explanation() {
    return (
        <div className="absolute flex items-center justify-center w-full h-full lg:text-3xl md:text-xl text-neutral-700 dark:text-stone-50 ">
            <div className="relative w-[50%]  h-[30%] max-sm:-top-[25%]">
                ...
                <div className="absolute top-[50%] left-[50%] -translate-x-[10%] -translate-y-[60%] rounded-full  border-2 border-neutral-700 dark:border-neutral-50 w-[1em] h-[1em]  animate-section_skill_click_round_animation" />
            </div>
        </div>
    );
}
