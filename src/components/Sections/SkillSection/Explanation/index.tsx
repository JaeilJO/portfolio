...
function Explanation() {
    return (
        <div className="absolute flex items-center justify-center w-full lg:text-3xl md:text-xl text-neutral-700 dark:text-stone-50 ">
            <div className="absolute w-[100%] h-[20rem] max-sm:h-full top-2/4 translate-y-[-45%]">
