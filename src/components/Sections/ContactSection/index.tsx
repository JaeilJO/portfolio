        ...
        <div className="flex w-screen h-screen max-sm:flex-col">
            ...
            <div className="flex items-center justify-center grow-[1] text-2xl  max-sm:text-[1.2rem] max-sm:items-start px-10 ">
                <form className="relative flex flex-col justify-center w-full " ref={form} onSubmit={sendEmail}>
                    <label className="font-light max-md:text-center">Email</label>
                    <input
                        type="email"
                        name="email"
                        className="p-3 mt-1 mb-10 text-2xl font-thin border-b-2 border-stone-200 bg-inherit focus:outline-none max-md:text-center max-sm:text-lg"
                        required
                    />

                    <label className="font-light max-md:text-center">Name</label>
                    <input
                        type="text"
                        name="name"
                        className="p-3 mt-1 mb-10 text-2xl font-thin border-b-2 border-stone-200 bg-inherit focus:outline-none max-md:text-center max-sm:text-lg"
                    ...
                    <label className="font-light max-md:text-center">Message</label>
                    <textarea
                        className="p-3 mt-1 mb-10 text-lg font-thin border-b-2 bg-inherit focus:outline-none "
                        ref={textarea}
